...
public class faculty_profile extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (user != null) {
            if (user.getPhotoUrl() != null) {
                Glide.with(faculty_profile.this)
        ...
        if (user != null) {
            databaseReference = FirebaseDatabase.getInstance().getReference().child("Faculty").child(user.getUid());
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if(result==null){
                Toast.makeText(faculty_profile.this,"You cancelled uploading profile image!",Toast.LENGTH_SHORT).show();
            }else {
                ...
                if(resultCode == RESULT_OK) {
                    try {
                        ...
                        handleUpload(bitmap);
                        Toast.makeText(faculty_profile.this,"Updated Successfully!",Toast.LENGTH_LONG).show();
                    }
                    catch (IOException e) {
                        e.printStackTrace();
                    }
    ...
    public void setUserProfileUrl(Uri uri) {
        ...
        Objects.requireNonNull(user).updateProfile(request)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(faculty_profile.this, "Profile image failed...", Toast.LENGTH_LONG).show();
                    }
                });
    }
    ...
    public void QR()
    {
        ValueEventListener postListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Faculty post = dataSnapshot.getValue(Faculty.class);
    ...
    public void Signout(View v){
        ...
        popupMenu.inflate(R.menu.popup_menu_faculty);
        popupMenu.show();
    }
    @Override
    public boolean onMenuItemClick(MenuItem menuItem) {
        ...
        SharedPreferences sharedPreferences= getSharedPreferences("faculty_login",MODE_PRIVATE);
        SharedPreferences.Editor editors=sharedPreferences.edit();
        editors.putBoolean("isFirsttime",true);
        editors.apply();

        Intent intent=new Intent(faculty_profile.this,MainActivity.class);
